...
namespace MinesweeperMVC.Services.Data
{
    public class GameDAO
    {
        ...
        public GameDAO()
        {
            MineLogger.getInstance().Info("GameDAO instantiated");
            conn = new SqlConnection(connString);
        }

        public bool SaveGame(int userId, ButtonModel[,] bm, bool autoSave, string name)
        {
            MineLogger.getInstance().Info("SaveGame method invoked in GameDAO");
            try
            {
                string query;
        ...
        {
            MineLogger.getInstance().Info("CountSaves method invoked in GameDAO");
            try
            {
        ...
        {
            MineLogger.getInstance().Info("GetOldest method invoked in GameDAO");
            try
            {
                int gameId = 0;
        ...
        {
            MineLogger.getInstance().Info("CheckSaves method invoked in GameDAO");
            try
            {
                string query;
                if (auto)
        ...
        {
            MineLogger.getInstance().Info("SetArray method invoked in GameDAO");
            int size = 0;
            try
            {
                string serArray = "";
        ...
        {
            MineLogger.getInstance().Info("DeleteSave method invoked in GameDAO");
            try
            {
                string query;
        ...
        {
            MineLogger.getInstance().Info("GetSaves method invoked in GameDAO");
            try
            {
